...
export default function GamePage() {
    ...
    const { data: player1Raw, error: player1Error, isLoading: player1Loading, refetch: refetchPlayer1 } = useReadContract({
    ...
    const { data: player2Raw, error: player2Error, isLoading: player2Loading, refetch: refetchPlayer2 } = useReadContract({
        address: gameAddress as `0x${string}`,
        abi: PlayGroundABI.abi,
    ...
    // Removed unused waitDuration and owner variables
    ...
    }, [gameAddress, connectedAddress, player1Data, player2Data, player1Error, player2Error, player1Loading, player2Loading, targetNetwork]);
    ...
    const canSubmitMoves = isPlayer && (gameState === 0 || gameState === undefined) && hasGameStarted && (timeRemaining > 0);
                            ...
                            <p className="text-2xl font-bold">
                                {!isMounted
                                    ...
                                    : isWaitingPhase
                                        ...
                                        : hasGameStarted
                                            ? (timeRemaining > 0 ? `${timeRemaining}s` : isTimeUp ? "Time&apos;s Up!" : `${timeRemaining}s`)
                                            : "Ready"}
                            </p>
                        </div>
                        <div>
                ...
                <div className="card-body">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-primary text-primary-content rounded-lg p-6">
                            ...
                            <p className="text-sm mb-1">{connectedAddress === player1Data?.playerAddress ? player1Data?.name : player2Data?.name}</p>
                        ...
                        <div className="bg-base-300 rounded-lg p-6">
                            ...
                            <p className="text-sm mb-1">{connectedAddress === player1Data?.playerAddress ? player2Data?.name : player1Data?.name}</p>
                            <div className="text-xs opacity-70 mb-4">
                                <Address address={connectedAddress === player1Data?.playerAddress ? player2Data?.playerAddress : player1Data?.playerAddress} />
                            </div>
                            ...
                            {moves.map((move, index) => (
                                <div key={index} className="form-control">
                                    <label className="label">
                                        <span className="label-text font-semibold text-lg">Move {index + 1}: {MOVE_NAMES[move]}</span>
                                    </label>
